            ...
            <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
              ...
              {sections.customer && (
                <div className="grid-2 mobile-form-grid" style={{ borderTop: '1px solid var(--color-border)' }}>
                  ...
                  <div><label style={{ display: 'block', marginBottom: '0.4rem', fontWeight: 500, fontSize: '0.9rem' }}>Customer Reference No.</label><input type="text" value={formData.customer_reference_no} onChange={e => setField('customer_reference_no', e.target.value)} /></div>
                </div>
              )}
            </div>
